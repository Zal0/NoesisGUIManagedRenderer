...
namespace WaveEngine.NoesisGUI
{
    internal class NoesisKeyCodes
    {
        ...
        static NoesisKeyCodes()
        {
            ...
            noesisKeyCode.Add(Keys.NumPad0, Key.NumPad0);
            noesisKeyCode.Add(Keys.NumPad1, Key.NumPad1);
            noesisKeyCode.Add(Keys.NumPad2, Key.NumPad2);
            noesisKeyCode.Add(Keys.NumPad3, Key.NumPad3);
            noesisKeyCode.Add(Keys.NumPad4, Key.NumPad4);
            noesisKeyCode.Add(Keys.NumPad5, Key.NumPad5);
            noesisKeyCode.Add(Keys.NumPad6, Key.NumPad6);
            noesisKeyCode.Add(Keys.NumPad7, Key.NumPad7);
            noesisKeyCode.Add(Keys.NumPad8, Key.NumPad8);
            noesisKeyCode.Add(Keys.NumPad9, Key.NumPad9);
            ...
            noesisKeyCode.Add(Keys.NumLock, Key.NumLock);
            noesisKeyCode.Add(Keys.Scroll, Key.Scroll);

            //noesisKeyCode.Add(Keys.Equals, Key.OemPlus);
            //noesisKeyCode.Add(Keys.Plus, Key.OemPlus);
            noesisKeyCode.Add(Keys.OemComma, Key.OemComma);
            //noesisKeyCode.Add(Keys.Minus, Key.OemMinus);
            noesisKeyCode.Add(Keys.OemPeriod, Key.OemPeriod);
            noesisKeyCode.Add(Keys.OemQuestion, Key.OemQuestion);

            noesisKeyCode.Add(Keys.OemBackslash, Key.OemBackslash);
            //noesisKeyCode.Add(Keys.LeftBracket, Key.OemOpenBrackets);
            //noesisKeyCode.Add(Keys.RightBracket, Key.OemCloseBrackets);
            noesisKeyCode.Add(Keys.OemSemicolon, Key.OemSemicolon);
