...
void main()
{
    ...
    {
        vec2 _112 = vec2(Buffer2.blurSize * Buffer1.textureSize.z, 0.0) * _82[_106];
        vec2 _117 = in_var_TEXCOORD1 - vec2(Buffer2.shadowOffset.x * Buffer1.textureSize.z, Buffer2.shadowOffset.y * Buffer1.textureSize.w);
    ...
    vec4 _138 = texture(SPIRV_Cross_CombinedimageimageSampler, clamp(in_var_TEXCOORD1, in_var_TEXCOORD2.xy, in_var_TEXCOORD2.zw));
